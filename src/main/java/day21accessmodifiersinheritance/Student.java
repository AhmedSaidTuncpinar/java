...
public class Student {
    //Public is accessible from entire the project, there is no restriction
    public String stdName = "Tom Hanks";

    //Private can be used just inside the "Student" class.
    //Private can be used just inside the class it was created
    private String stdId = "TH202217007";

    //Default can be used just inside the "day20accessmodifiersinheritance" package
    //Default can be used just inside the package it was created
    double stdGpa = 3.83;//If you do not type any access modifier it will be "default"

    // protected can be used inside the "day20accessmodifiersinheritance" package, and from the child classes in other packages
