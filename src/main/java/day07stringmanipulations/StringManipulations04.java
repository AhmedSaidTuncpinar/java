...
public class StringManipulations04 {
    ...
    public static void main(String[] args) {
        ...
        //Example 1: Change alll digit to "*" in the given String.
        // 1. Way Not recommended because there is repition.
        ...
        //Note: if your code does not work for all values, it is called "Hard Coding". Har Coding can not be accepted.
        // 2. Way
