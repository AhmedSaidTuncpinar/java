...
public class Switch01 {
    ...
    public static void main(String[] args) {
       ...
       // Ask user to enter country name among "America, England, Germany, Turkey, India, Peru, Spain, Bulgaria, Albania, France"
        ...
        switch (country) { //note: inside the switch parenthesis, you can use just int, byte, short, char, and string data types.
// you can not use boolean, float or double or long.
            case "america":
