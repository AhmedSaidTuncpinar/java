...
double a1 = 2.99, a2 = 2.89, a3 = 3.79;
        System.out.println("Total Price"+ (a1 + a2 + a3));

float b1 = 0.980F;
long b2 = 75000000;
int b3 = 12000;

        System.out.println("Total Value" + (b1 * b2 * b3));

        String ast = "Ahmed Said";
        long ast1 = 12000L;
        long ast2 = 12500L;
        System.out.println(ast + (ast1 + ast2));
        System.out.println(ast + (ast1*ast2));
        boolean a = true;
        boolean b = false;
        System.out.println(a + "12" +b);

float book = 6.99F, noteBook=2.99F, laptop=59.99F;
float totalPrice= 2*book + 4*noteBook + 3*laptop;
        ...
        int abz=13, abz1=21;
        String abz2= "Tom";
        System.out.println(abz+abz1+abz2);
